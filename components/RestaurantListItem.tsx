  ...
  return (
    <div className="w-[327px] h-[202px] bg-white border-munchies-gray rounded-lg shadow-sm relative overflow-hidden flex flex-col justify-between p-4">
       ...
       <div className="flex flex-row justify-between">
        <p>{restaurant.name}</p>
        <Button variant="default" className="bg-munchies-green w-8 h-8 rounded-full text-white  hover:bg-green-700 hover:scale-105 hover:shadow-lg  active:bg-green-800 active:scale-95 active:shadow-sm  ">
            <ArrowRight/>
        </Button>
       </div>
    </div>
